      ...
      <div className="flex flex-col items-center md:flex-row">
        <div>
          <img
            ...
            className={`h-62.5 w-62.5 rounded-[20px] object-cover shadow-[0px_6px_15px_rgba(0,0,0,0.15)] transition-[0.3s] ${
        ...
        <div className="ml-5 flex h-62.5 w-full flex-col overflow-y-scroll [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
